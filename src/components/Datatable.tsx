...
import { useGetData } from '../custom-hooks/FetchData'; // Corrected import
...
const columns: GridColDef[] = [
    ...
    { field: 'book_length', headerName: "Length", flex: 1},
    { field: 'year_of_release', headerName: "Year", flex: 1},
    { field: 'in_stock', headerName: "In Stock?", flex: 1}
]

function DataTable() {
    let [ open, setOpen ] = useState(false);
    const { bookData, getData } = useGetData(); // Corrected hook name
